...
class FastKarnatakaBMRDATilesUploader:
    ...
    def __init__(self):
        ...
        self.folder_mappings = {
            'anekal_masterplan_tiles': 'karnataka/bmrda/bmrda_anekal_masterplan',
            'hosakote_masterplan_tiles': 'karnataka/bmrda/bmrda_hosakote_masterplan',
            'chikkaballapura_masterplan_tiles': 'karnataka/bmrda/bmrda_chikkaballapura_masterplan',
            'nelamangala_masterplan_tiles': 'karnataka/bmrda/bmrda_nelamangala_masterplan'
        }
...
def main():
    ...
    try:
        uploader = FastKarnatakaBMRDATilesUploader()
