#!/usr/bin/env python3
"""
Test script to check RRR tiles for edge artifacts
"""
...
def test_rrr_tiles():
    """Test the specific RRR tiles for edge artifacts"""
    
    print("🔍 Testing RRR Tiles for Edge Artifacts")
    print("=" * 60)
    ...
    for test_zoom, test_x, test_y in test_tiles:
        print(f"\n📍 Testing Tile: {test_zoom}/{test_x}/{test_y}")
        print("-" * 40)
        
        # Local tile path
        local_path = f"static/tiles_png/telangana/hyderabad/hyderabad_rrr/tiles_png/{test_zoom}_{test_x}_{test_y}.png"
        
        # S3 tile URL
        s3_url = f"https://gis-portal-layers.s3.amazonaws.com/telangana/hyderabad/hyderabad_rrr/{test_zoom}/{test_x}/{test_y}.png"
        ...
        try:
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    s3_path = f"hyderabad_rrr_s3_{test_zoom}_{test_x}_{test_y}.png"
