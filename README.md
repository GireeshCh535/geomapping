...
```
cd existing_repo
git remote add origin https://gitlab.com/rohit.boni/geomapping.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/rohit.boni/geomapping/-/settings/integrations)
