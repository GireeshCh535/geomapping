#!/usr/bin/env python3
"""
Detailed analysis of Hosur master plan GeoTIFF file
"""
...
def analyze_hosur_geotiff():
    """Detailed analysis of Hosur GeoTIFF"""
    geotiff_path = "data/tamil_nadu/hosur/hosur_master_plan/Hosur_MDP_Clipped.tif"
                        ...
                        if src.count >= 3:  # RGB or RGBA
                            ...
                            if chunk_non_zero > 0 and len(sample_pixels) < 20:
                                ...
                                for i in range(min(5, len(non_zero_indices[0]))):
                                    y, x = non_zero_indices[0][i], non_zero_indices[1][j]
                                    pixel_data = data[:, y, x]
