#!/usr/bin/env python3
"""
Analyze Pithampur Land Use Plan GeoTIFF to extract metadata, CRS, bounds, and band information
"""
...
def main():
    """Main function to analyze Pithampur GeoTIFF"""
    # Path to the Pithampur GeoTIFF
    tiff_path = "data/madhya-pradesh/pithampur/PithampurLandusePlan_clipped.tif"
