#!/usr/bin/env python3
"""
Analyze Ajmer Master Development Plan GeoTIFF to extract metadata, CRS, bounds, and band information
"""
...
def main():
    """Main function to analyze Ajmer GeoTIFF"""
    # Path to the Ajmer GeoTIFF
    tiff_path = "data/rajasthan/ajmer/Ajmer_MDP_2033_Clipped.tif"
