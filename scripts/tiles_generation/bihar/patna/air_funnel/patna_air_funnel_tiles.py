#!/usr/bin/env python3
"""
Patna Air Funnel Zones Tile Generator
...
class PatnaAirFunnelTileGenerator:
    ...
    def get_color_map(self):
        """Color mapping for height restriction zones (Patna)"""
        return {
            'For construction mandatory NOC from AAI is required': {'fill': '#91302D', 'outline': '#6B2421'},
            '53 Meters Above Mean Sea Level': {'fill': '#559B33', 'outline': '#3F7326'},
            '73 Meters Above Mean Sea Level': {'fill': '#8B36A4', 'outline': '#682881'},
            '83 Meters Above Mean Sea Level': {'fill': '#CF9D2C', 'outline': '#A37D23'},
            '193 Meters Above Mean Sea Level': {'fill': '#A0A0A0', 'outline': '#787878'},
        }
...
def main():
    ...
    try:
        # Paths
        data_path = project_root / "data" / "bihar" / "patna" / "air_funnel_zones" / "Patna.geojson"
