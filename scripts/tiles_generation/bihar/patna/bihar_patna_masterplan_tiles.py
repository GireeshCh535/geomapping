#!/usr/bin/env python3
"""
Dedicated script to generate high-quality PNG tiles from Patna Masterplan RGBA GeoTIFF
...
class PatnaRGBATileGenerator:
    """
    Generate high-quality PNG tiles from Patna Masterplan RGBA GeoTIFF
    """
    
    def __init__(self, data_dir: str = "data/bihar/patna",
                 output_dir: str = "patna_masterplan_tiles"):
        self.data_dir = Path(data_dir)
        self.output_dir = Path(output_dir)
        self.output_dir.mkdir(exist_ok=True)
        
        logger.info("Patna RGBA Tile Generator initialized")
    ...
    def generate_tiles(self, min_zoom=8, max_zoom=16):
        """Generate PNG tiles for Patna Masterplan"""
        ...
        logger.info(f"Generated {total_tiles} PNG tiles for Patna Masterplan")
    ...
    def create_supporting_files(self, bounds, min_zoom, max_zoom):
        ...
        style_json = {
            "version": 8,
            "name": "Bihar - Patna Masterplan",
            "sources": {
                "patna-masterplan": {
                    "type": "raster",
                    "tiles": [
                        "https://d17yosovmfjm4.cloudfront.net/bihar/patna_masterplan/{z}/{x}/{y}.png"
                    ],
                    "tileSize": 256
                }
            },
            "layers": [
                {
                    "id": "patna-masterplan-layer",
                    "type": "raster",
                    "source": "patna-masterplan",
                    "paint": {
                        "raster-opacity": 0.8
                    }
                }
        ...
        tilejson = {
            "tilejson": "2.2.0",
            "name": "Bihar - Patna Masterplan",
            "description": "Master plan tiles for Patna, Bihar",
            "version": "1.0.0",
            "attribution": "Patna Development Authority",
            "template": "",
            "legend": "",
            "scheme": "xyz",
            "tiles": [
...
<html>
<head>
    <title>Bihar - Patna Masterplan</title>
...
def main():
    """Main function"""
    logger.info("Starting Patna RGBA Masterplan tile generation")
    
    # Initialize generator
    generator = PatnaRGBATileGenerator()
    
    # Generate tiles with higher zoom levels for better quality
    generator.generate_tiles(min_zoom=17, max_zoom=18)
    
    logger.info("Patna RGBA Masterplan tile generation completed!")
