#!/usr/bin/env python3
"""
Chennai Air Funnel Zones Tile Generator
...
class ChennaiAirFunnelTileGenerator:
    ...
    def get_color_map(self):
        """Color mapping for height restriction zones (Chennai)"""
        return {
            'For construction mandatory NOC from AAI is required': {'fill': '#91302D', 'outline': '#6B2421'},
            '26 Meters Above Mean Sea Level': {'fill': '#559B33', 'outline': '#3F7326'},
            '31 Meters Above Mean Sea Level': {'fill': '#7EBC4F', 'outline': '#5F8E3B'},
            '36 Meters Above Mean Sea Level': {'fill': '#8B36A4', 'outline': '#682881'},
            '46 Meters Above Mean Sea Level': {'fill': '#C157D9', 'outline': '#9333B3'},
            '56 Meters Above Mean Sea Level': {'fill': '#CF9D2C', 'outline': '#A37D23'},
            '66 Meters Above Mean Sea Level': {'fill': '#F2B02C', 'outline': '#B88522'},
            '96 Meters Above Mean Sea Level': {'fill': '#3A6A99', 'outline': '#2C5073'},
            '126 Meters Above Mean Sea Level': {'fill': '#BFC040', 'outline': '#8F9030'},
            '156 Meters Above Mean Sea Level': {'fill': '#A0A0A0', 'outline': '#787878'},
        }
...
def main():
    ...
    try:
        # Paths
        data_path = project_root / "data" / "tamil-nadu" / "chennai" / "air_funnel_zones" / "Chennai.geojson"
