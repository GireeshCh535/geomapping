#!/usr/bin/env python3
"""
Bengaluru Air Funnel Zones Tile Generator
Generates PNG tiles for CCZM BIAL (Bangalore International Airport) Height Restriction Zones
Based on Hyderabad air funnel rendering approach
"""
...
# Script is at: scripts/tiles_generation/karnataka_bengaluru_air_funnel_tiles.py
...
class BengaluruAirFunnelTileGenerator:
    ...
    def get_color_map(self):
        """Color mapping for height restriction zones (Bangalore)"""
        return {
            'Mandatory NOC from AAI is required': {'fill': '#91302D', 'outline': '#6B2421'},
            '925 Meters Above Mean Sea Level': {'fill': '#559B33', 'outline': '#3F7326'},
            '930 Meters Above Mean Sea Level': {'fill': '#7EBC4F', 'outline': '#5F8E3B'},
            '955 Meters Above Mean Sea Level': {'fill': '#8B36A4', 'outline': '#682881'},
            '965 Meters Above Mean Sea Level': {'fill': '#CF9D2C', 'outline': '#A37D23'},
            '995 Meters Above Mean Sea Level': {'fill': '#3A6A99', 'outline': '#2C5073'},
            '1025 Meters Above Mean Sea Level': {'fill': '#BFC040', 'outline': '#8F9030'},
            '1055 Meters Above Mean Sea Level': {'fill': '#A0A0A0', 'outline': '#787878'},
        }
...
<head>
  ...
  <title>Bengaluru Air Funnel Zones Viewer</title>
...
<body>
  ...
  <div class="info-box">
    <strong>Bengaluru Air Funnel Zones</strong><br>
    BIAL Height Restrictions<br>
...
def main():
    """Main function"""
    print("=== Bengaluru Air Funnel Zones Tile Generator ===")
    print("Generating tiles for BIAL airport height restriction zones\n")
    
    settings = DEFAULT_VIEW_SETTINGS
    
    try:
        # Paths
        data_path = project_root / "data" / "karnataka" / "bengaluru" / "air_funnel_zones" / "CCZM_BIAL_Handover.geojson"
        output_dir = project_root / "bengaluru_air_funnel_tiles"
        
        # Initialize generator
        generator = BengaluruAirFunnelTileGenerator(
            data_path=data_path,
