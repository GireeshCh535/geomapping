#!/usr/bin/env python3
"""
Ahmedabad - Gandhinagar Air Funnel Zones Tile Generator
Generates PNG tiles for Airport Height Restriction Zones
Based on Hyderabad, Bengaluru, and Kozhikode air funnel rendering approach
"""
...
class AhmedabadGandhinagarAirFunnelTileGenerator:
    ...
    def get_color_map(self):
        """Color mapping for height restriction zones (Ahmedabad - Gandhinagar)"""
        return {
            'For construction mandatory NOC from AAI is required': {'fill': '#91302D', 'outline': '#6B2421'},
            '77 Meters Above Mean Sea Level': {'fill': '#559B33', 'outline': '#3F7326'},
            '95 Meters Above Mean Sea Level': {'fill': '#8B36A4', 'outline': '#682881'},
            '115 Meters Above Mean Sea Level': {'fill': '#CF9D2C', 'outline': '#A37D23'},
            '135 Meters Above Mean Sea Level': {'fill': '#3A6A99', 'outline': '#2C5073'},
            '155 Meters Above Mean Sea Level': {'fill': '#A0A0A0', 'outline': '#787878'},
        }
...
<head>
  ...
  <title>Ahmedabad - Gandhinagar Air Funnel Zones Viewer</title>
...
<body>
  ...
  <div class="info-box">
    <strong>Ahmedabad - Gandhinagar Air Funnel Zones</strong><br>
...
def main():
    """Main function"""
    print("=== Ahmedabad - Gandhinagar Air Funnel Zones Tile Generator ===")
    ...
    try:
        # Paths
        data_path = project_root / "data" / "gujarat" / "ahmedabad-gandhinagar" / "air_funnel_zones" / "Ahmedabad - Gandhinagar.geojson"
        output_dir = project_root / "ahmedabad_gandhinagar_air_funnel_tiles"
        
        # Initialize generator
        generator = AhmedabadGandhinagarAirFunnelTileGenerator(
            data_path=data_path,
