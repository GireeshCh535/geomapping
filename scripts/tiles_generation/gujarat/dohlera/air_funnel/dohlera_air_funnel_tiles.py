#!/usr/bin/env python3
"""
Dohlera Air Funnel Zones Tile Generator
...
class DohleraAirFunnelTileGenerator:
    ...
    def get_color_map(self):
        """Color mapping for height restriction zones (Dohlera)"""
        return {
            'For construction mandatory NOC from AAI is required': {'fill': '#91302D', 'outline': '#6B2421'},
            '32 Meters Above Mean Sea Level': {'fill': '#559B33', 'outline': '#3F7326'},
            '42 Meters Above Mean Sea Level': {'fill': '#8B36A4', 'outline': '#682881'},
            '72 Meters Above Mean Sea Level': {'fill': '#CF9D2C', 'outline': '#A37D23'},
            '102 Meters Above Mean Sea Level': {'fill': '#3A6A99', 'outline': '#2C5073'},
            '152 Meters Above Mean Sea Level': {'fill': '#A0A0A0', 'outline': '#787878'},
        }
...
def main():
    ...
    try:
        # Paths
        data_path = project_root / "data" / "gujarat" / "dholera" / "air_funnel_zones" / "Dohlera.geojson"
