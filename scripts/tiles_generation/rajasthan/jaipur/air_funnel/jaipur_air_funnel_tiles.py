#!/usr/bin/env python3
"""
Jaipur Air Funnel Zones Tile Generator
...
class JaipurAirFunnelTileGenerator:
    ...
    def get_color_map(self):
        """Color mapping for height restriction zones (Jaipur)"""
        return {
            'For construction mandatory NOC from AAI is required': {'fill': '#91302D', 'outline': '#6B2421'},
            '396 Meters Above Mean Sea Level': {'fill': '#559B33', 'outline': '#3F7326'},
            '401 Meters Above Mean Sea Level': {'fill': '#8B36A4', 'outline': '#682881'},
            '406 Meters Above Mean Sea Level': {'fill': '#C157D9', 'outline': '#9333B3'},
            '416 Meters Above Mean Sea Level': {'fill': '#CF9D2C', 'outline': '#A37D23'},
            '466 Meters Above Mean Sea Level': {'fill': '#3A6A99', 'outline': '#2C5073'},
            '496 Meters Above Mean Sea Level': {'fill': '#BFC040', 'outline': '#8F9030'},
            '526 Meters Above Mean Sea Level': {'fill': '#A0A0A0', 'outline': '#787878'},
        }
...
def main():
    ...
    try:
        # Paths
        data_path = project_root / "data" / "rajasthan" / "jaipur" / "air_funnel_zones" / "Jaipur.geojson"
