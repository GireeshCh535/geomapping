#!/usr/bin/env python3
"""
Kozhikode (Calicut) Air Funnel Zones Tile Generator
Generates PNG tiles for Airport Height Restriction Zones
Based on Hyderabad and Bengaluru air funnel rendering approach
"""
...
class KozhikodeAirFunnelTileGenerator:
    ...
    def get_color_map(self):
        """Color mapping for height restriction zones (Kozhikode/Calicut)"""
        return {
            'For construction mandatory NOC from AAI is required': {'fill': '#91302D', 'outline': '#6B2421'},
            '144 Meters Above Mean Sea Level': {'fill': '#559B33', 'outline': '#3F7326'},
            '164 Meters Above Mean Sea Level': {'fill': '#8B36A4', 'outline': '#682881'},
            '184 Meters Above Mean Sea Level': {'fill': '#CF9D2C', 'outline': '#A37D23'},
            '204 Meters Above Mean Sea Level': {'fill': '#A0A0A0', 'outline': '#787878'},
        }
...
<head>
  ...
  <title>Kozhikode Air Funnel Zones Viewer</title>
...
<body>
  ...
  <div class="info-box">
    <strong>Kozhikode Air Funnel Zones</strong><br>
...
def main():
    """Main function"""
    print("=== Kozhikode (Calicut) Air Funnel Zones Tile Generator ===")
    ...
    try:
        # Paths
        data_path = project_root / "data" / "kerala" / "kozhikode" / "air_funnel_zones" / "(khozikode)Calicut.geojson"
        output_dir = project_root / "kozhikode_air_funnel_tiles"
        
        # Initialize generator
        generator = KozhikodeAirFunnelTileGenerator(
            data_path=data_path,
