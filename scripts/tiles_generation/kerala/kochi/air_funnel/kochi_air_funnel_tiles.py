#!/usr/bin/env python3
"""
Kochi Air Funnel Zones Tile Generator
...
class KochiAirFunnelTileGenerator:
    ...
    def get_color_map(self):
        """Color mapping for height restriction zones (Kochi)"""
        return {
            'For construction mandatory NOC from AAI is required': {'fill': '#91302D', 'outline': '#6B2421'},
            '19 Meters Above Mean Sea Level': {'fill': '#559B33', 'outline': '#3F7326'},
            '29 Meters Above Mean Sea Level': {'fill': '#8B36A4', 'outline': '#682881'},
            '39 Meters Above Mean Sea Level': {'fill': '#CF9D2C', 'outline': '#A37D23'},
            '49 Meters Above Mean Sea Level': {'fill': '#3A6A99', 'outline': '#2C5073'},
            '119 Meters Above Mean Sea Level': {'fill': '#AA8F9D', 'outline': '#806A75'},
...
def main():
    ...
    try:
        # Paths
        data_path = project_root / "data" / "kerala" / "kochi" / "air_funnel_zones" / "Kochi.geojson"
