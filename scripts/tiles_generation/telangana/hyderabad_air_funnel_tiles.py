#!/usr/bin/env python3
"""
Hyderabad Air Funnel Zones Tile Generator
Generates PNG tiles for CCZM (Airport Height Restriction Zones)
Based on Warangal masterplan rendering approach
"""
...
class HyderabadAirFunnelTileGenerator:
    ...
    def get_color_map(self):
        ...
        return {
            'Mandatory NOC from AAI is required': {'fill': '#91302D', 'outline': '#6B2421'},
            '565 Meters Above Mean Sea Level': {'fill': '#559B33', 'outline': '#3F7326'},
            '580 Meters Above Mean Sea Level': {'fill': '#8B36A4', 'outline': '#682881'},
            '600 Meters Above Mean Sea Level': {'fill': '#D26E6E', 'outline': '#A85555'},
            '620 Meters Above Mean Sea Level': {'fill': '#CF9D2C', 'outline': '#A37D23'},
            '640 Meters Above Mean Sea Level': {'fill': '#7EBC4F', 'outline': '#5F8E3B'},
            '660 Meters Above Mean Sea Level': {'fill': '#3A6A99', 'outline': '#2C5073'},
            '675 Meters Above Mean Sea Level': {'fill': '#5F84B1', 'outline': '#476385'},
            '700 Meters Above Mean Sea Level': {'fill': '#BFC040', 'outline': '#8F9030'},
            '720 Meters Above Mean Sea Level': {'fill': '#AA8F9D', 'outline': '#806B75'},
            '740 Meters Above Mean Sea Level': {'fill': '#C0A2B1', 'outline': '#907A85'},
            '760 Meters Above Mean Sea Level': {'fill': '#A0A0A0', 'outline': '#787878'},
        }
    ...
    def load_data(self):
        ...
        for feature in features:
            try:
                ...
                height_zone = props.get('Pemissible Height', 'Unknown')
...
<head>
  ...
  <title>Hyderabad Air Funnel Zones Viewer</title>
...
<body>
  ...
  <div class="info-box">
    <strong>Hyderabad Air Funnel Zones</strong><br>
  ...
  <div class="legend">
    ...
    <div class="legend-item">
      ...
      <span style="font-size: 10px;">565m</span>
    </div>
    <div class="legend-item">
      <div class="legend-color" style="background-color: #8B36A4;"></div>
      <span style="font-size: 10px;">580m</span>
    </div>
    <div class="legend-item">
      <div class="legend-color" style="background-color: #D26E6E;"></div>
      <span style="font-size: 10px;">600m</span>
    </div>
    <div class="legend-item">
      <div class="legend-color" style="background-color: #CF9D2C;"></div>
      <span style="font-size: 10px;">620m</span>
    </div>
    <div class="legend-item">
      <div class="legend-color" style="background-color: #7EBC4F;"></div>
      <span style="font-size: 10px;">640m</span>
    </div>
    <div class="legend-item">
      <div class="legend-color" style="background-color: #3A6A99;"></div>
      <span style="font-size: 10px;">660m</span>
    </div>
    <div class="legend-item">
      <div class="legend-color" style="background-color: #5F84B1;"></div>
      <span style="font-size: 10px;">675m</span>
    </div>
    <div class="legend-item">
      <div class="legend-color" style="background-color: #BFC040;"></div>
      <span style="font-size: 10px;">700m</span>
    </div>
    <div class="legend-item">
      <div class="legend-color" style="background-color: #AA8F9D;"></div>
      <span style="font-size: 10px;">720m</span>
    </div>
    <div class="legend-item">
      <div class="legend-color" style="background-color: #C0A2B1;"></div>
      <span style="font-size: 10px;">740m</span>
    </div>
    <div class="legend-item">
      <div class="legend-color" style="background-color: #A0A0A0;"></div>
      <span style="font-size: 10px;">760m</span>
    </div>
  </div>
...
def main():
    """Main function"""
    print("=== Hyderabad Air Funnel Zones Tile Generator ===")
    ...
    try:
        # Paths
        data_path = project_root / "data" / "Telangana" / "hyderabad" / "air_funnel_zones" / "CCZM_Hyderabad_Handover.geojson"
        output_dir = project_root / "hyderabad_air_funnel_tiles"
        
        # Initialize generator
        generator = HyderabadAirFunnelTileGenerator(
            data_path=data_path,
