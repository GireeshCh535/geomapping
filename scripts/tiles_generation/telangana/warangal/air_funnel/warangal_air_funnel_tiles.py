#!/usr/bin/env python3
"""
Warangal Air Funnel Zones Tile Generator
...
class WarangalAirFunnelTileGenerator:
    ...
    def get_color_map(self):
        """Color mapping for height restriction zones (Warangal)"""
        return {
            'For construction mandatory NOC from AAI is required': {'fill': '#91302D', 'outline': '#6B2421'},
            '313 Meters Above Mean Sea Level': {'fill': '#559B33', 'outline': '#3F7326'},
            '323 Meters Above Mean Sea Level': {'fill': '#8B36A4', 'outline': '#682881'},
            '333 Meters Above Mean Sea Level': {'fill': '#CF9D2C', 'outline': '#A37D23'},
            '343 Meters Above Mean Sea Level': {'fill': '#3A6A99', 'outline': '#2C5073'},
            '373 Meters Above Mean Sea Level': {'fill': '#BFC040', 'outline': '#8F9030'},
            '403 Meters Above Mean Sea Level': {'fill': '#AA8F9D', 'outline': '#806A75'},
            '433 Meters Above Mean Sea Level': {'fill': '#A0A0A0', 'outline': '#787878'},
        }
...
<head>
  ...
  <title>Warangal Air Funnel Zones Viewer</title>
...
<body>
  ...
  <div class="info-box">
    <strong>Warangal Air Funnel Zones</strong><br>
...
def main():
    """Main function"""
    print("=== Warangal Air Funnel Zones Tile Generator ===")
    ...
    try:
        # Paths
        data_path = project_root / "data"/"andhra-pradesh"/ "warangal" / "air_funnel_zones" / "Warangal.geojson"
        output_dir = project_root / "warangal_air_funnel_tiles"
        
        # Initialize generator
        generator = WarangalAirFunnelTileGenerator(
            data_path=data_path,
