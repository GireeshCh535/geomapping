#!/usr/bin/env python3
"""
Tirupati Air Funnel Zones Tile Generator
...
class TirupatiAirFunnelTileGenerator:
    ...
    def get_color_map(self):
        """Color mapping for height restriction zones (Tirupati)"""
        return {
            'For construction mandatory NOC from AAI is required': {'fill': '#91302D', 'outline': '#6B2421'},
            '137 Meters Above Mean Sea Level': {'fill': '#559B33', 'outline': '#3F7326'},
            '147 Meters Above Mean Sea Level': {'fill': '#8B36A4', 'outline': '#682881'},
            '157 Meters Above Mean Sea Level': {'fill': '#CF9D2C', 'outline': '#A37D23'},
            '187 Meters Above Mean Sea Level': {'fill': '#3A6A99', 'outline': '#2C5073'},
            '217 Meters Above Mean Sea Level': {'fill': '#BFC040', 'outline': '#8F9030'},
            '247 Meters Above Mean Sea Level': {'fill': '#A0A0A0', 'outline': '#787878'},
        }
