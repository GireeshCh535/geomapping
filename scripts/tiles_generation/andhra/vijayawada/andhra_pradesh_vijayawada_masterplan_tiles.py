#!/usr/bin/env python3
"""
Dedicated script to generate high-quality PNG tiles from Vijayawada Master Plan RGBA GeoTIFF
...
class VijayawadaMasterplanTileGenerator:
    """
    ...
    def __init__(self, data_dir: str = "data/andhra_pradesh/MGTM/master_plan",
                 output_dir: str = "vijayawada_masterplan_tiles"):
        self.data_dir = Path(data_dir)
        self.output_dir = Path(output_dir)
        self.output_dir.mkdir(exist_ok=True)
        
        logger.info("Vijayawada Master Plan Tile Generator initialized")
    ...
    def generate_tiles(self, min_zoom=8, max_zoom=16):
        """Generate PNG tiles for Vijayawada Master Plan"""
...
def main():
    """Main function"""
    logger.info("=" * 80)
    logger.info("Starting Vijayawada Master Plan tile generation")
    logger.info("=" * 80)
    
    # Initialize generator
    generator = VijayawadaMasterplanTileGenerator()
    ...
    logger.info("=" * 80)
    logger.info("\nTo view the tiles:")
    logger.info("  1. cd vijayawada_masterplan_tiles")
