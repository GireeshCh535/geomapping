#!/usr/bin/env python3
"""
Optimized script to generate high-quality PNG tiles from Kakinada Master Plan RGBA GeoTIFF
Uses parallel processing and optimized algorithms for faster tile generation
"""
...
class OptimizedKakinadaTileGenerator:
    """
    ...
    def __init__(self, data_dir: str = "data/andhra_pradesh/kakinada/master_plan",
                 output_dir: str = "kakinada_masterplan_tiles1",
        ...
        logger.info(f"Kakinada Master Plan Tile Generator initialized with {self.num_workers} workers")
    ...
    def generate_tiles(self, min_zoom=4, max_zoom=18):
        """Generate PNG tiles for Kakinada Master Plan with optimized parallel processing"""
...
def main():
    ...
    logger.info("=" * 80)
    logger.info("Starting Optimized Kakinada Master Plan tile generation")
    logger.info("=" * 80)
    ...
    generator = OptimizedKakinadaTileGenerator(num_workers=None)  # Will auto-detect CPU cores
    ...
    logger.info("=" * 80)
    logger.info("\nTo view the tiles:")
    logger.info("  1. cd kakinada_masterplan_tiles1")
