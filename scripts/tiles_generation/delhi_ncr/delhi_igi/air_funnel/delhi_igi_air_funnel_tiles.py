#!/usr/bin/env python3
"""
Delhi-IGI Air Funnel Zones Tile Generator
...
class DelhiIGIAirFunnelTileGenerator:
    ...
    def get_color_map(self):
        """Color mapping for height restriction zones (Delhi-IGI)"""
        return {
            'For construction mandatory NOC from AAI is required': {'fill': '#91302D', 'outline': '#6B2421'},
            '245 Meters Above Mean Sea Level': {'fill': '#559B33', 'outline': '#3F7326'},
            '255 Meters Above Mean Sea Level': {'fill': '#7EBC4F', 'outline': '#5F8E3B'},
            '265 Meters Above Mean Sea Level': {'fill': '#8B36A4', 'outline': '#682881'},
            '285 Meters Above Mean Sea Level': {'fill': '#C157D9', 'outline': '#9333B3'},
            '295 Meters Above Mean Sea Level': {'fill': '#CF9D2C', 'outline': '#A37D23'},
            '315 Meters Above Mean Sea Level': {'fill': '#F2B02C', 'outline': '#B88522'},
            '325 Meters Above Mean Sea Level': {'fill': '#3A6A99', 'outline': '#2C5073'},
            '345 Meters Above Mean Sea Level': {'fill': '#5F84B1', 'outline': '#476385'},
            '355 Meters Above Mean Sea Level': {'fill': '#A0A0A0', 'outline': '#787878'},
        }
...
def main():
    ...
    try:
        # Paths
        data_path = project_root / "data" / "delhi" / "delhi-ncr" / "air_funnel_zones" / "Delhi-IGI.geojson"
        output_dir = project_root / "delhi_igi_air_funnel_tiles"
        
        # Initialize generator
        generator = DelhiIGIAirFunnelTileGenerator(
            data_path=data_path,
