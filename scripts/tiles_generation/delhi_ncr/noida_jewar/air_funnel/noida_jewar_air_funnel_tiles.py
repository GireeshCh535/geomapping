#!/usr/bin/env python3
"""
Noida (Jewar) Air Funnel Zones Tile Generator
...
class NoidaJewarAirFunnelTileGenerator:
    ...
    def get_color_map(self):
        """Color mapping for height restriction zones (Noida (Jewar))"""
        return {
            'For construction mandatory NOC from AAI is required': {'fill': '#91302D', 'outline': '#6B2421'},
            '214 Meters Above Mean Sea Level': {'fill': '#559B33', 'outline': '#3F7326'},
            '219 Meters Above Mean Sea Level': {'fill': '#7EBC4F', 'outline': '#5F8E3B'},
            '229 Meters Above Mean Sea Level': {'fill': '#8B36A4', 'outline': '#682881'},
            '239 Meters Above Mean Sea Level': {'fill': '#C157D9', 'outline': '#9333B3'},
            '249 Meters Above Mean Sea Level': {'fill': '#CF9D2C', 'outline': '#A37D23'},
            '279 Meters Above Mean Sea Level': {'fill': '#3A6A99', 'outline': '#2C5073'},
            '309 Meters Above Mean Sea Level': {'fill': '#BFC040', 'outline': '#8F9030'},
            '339 Meters Above Mean Sea Level': {'fill': '#A0A0A0', 'outline': '#787878'},
        }
...
def main():
    ...
    try:
        # Paths
        data_path = project_root / "data" / "delhi-ncr" / "delhi-ncr" / "air_funnel_zones" / "Noida(Jewar).geojson"
        output_dir = project_root / "noida_jewar_air_funnel_tiles"
        
        # Initialize generator
        generator = NoidaJewarAirFunnelTileGenerator(
            data_path=data_path,
