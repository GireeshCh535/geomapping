#!/usr/bin/env python3
"""
Yamuna Expressway Master Plan - SEAMLESS COMPLETE TILES
...
class YamunaExpresswaySeamlessTiles:
    ...
    def get_color_map(self):
        """Yamuna Expressway color mapping - matches geotif_yamuna_expressway.py"""
        ...
        return {
            ...
            "RAILWAY_LINES": {'fill': '#000000', 'outline': '#000000'},
            "MASTER PLAN": {'fill': None, 'outline': '#6E6E6E'},  # Outline only
            "MASTER_PLAN": {'fill': None, 'outline': '#6E6E6E'},
            "SECTORLAYOUT ALLOTED": {'fill': None, 'outline': '#000000'},
            "SECTORLAYOUT_ALLOTED": {'fill': None, 'outline': '#000000'},
            "SECTORLAYOUT RESERVED": {'fill': '#FF7F7F', 'outline': '#CC6666'},
            "SECTORLAYOUT_RESERVED": {'fill': '#FF7F7F', 'outline': '#CC6666'},
            "SECTORLAYOUT VACANT": {'fill': '#FFD37F', 'outline': '#CCAA66'},
            "SECTORLAYOUT_VACANT": {'fill': '#FFD37F', 'outline': '#CCAA66'},
            "SECTOR BOUNDARY": {'fill': None, 'outline': '#E69800'},
            "SECTOR_BOUNDARY": {'fill': None, 'outline': '#E69800'},
            "AOI": {'fill': None, 'outline': '#FF0000'},
            "AGRICULTURE": {'fill': '#ABE066', 'outline': '#8AB052'},
            "CANAL": {'fill': '#0070FF', 'outline': '#005ACC'},
            "CANAL GREENBELT": {'fill': '#55FF00', 'outline': '#44CC00'},
            "CANAL_GREENBELT": {'fill': '#55FF00', 'outline': '#44CC00'},
            "COMMERCIAL": {'fill': '#E60000', 'outline': '#B80000'},
            "DRAIN": {'fill': '#B5CBFD', 'outline': '#91A3CA'},
            "DRAIN GREENBELT": {'fill': '#55FF00', 'outline': '#44CC00'},
            "DRAIN_GREENBELT": {'fill': '#55FF00', 'outline': '#44CC00'},
            "FACILITY": {'fill': '#004DA8', 'outline': '#003D86'},
            "FOREST": {'fill': '#55FF00', 'outline': '#44CC00'},
            "GREEN BELT": {'fill': '#55FF00', 'outline': '#44CC00'},
            "GREEN_BELT": {'fill': '#55FF00', 'outline': '#44CC00'},
            "INDUSTRY": {'fill': '#C500FF', 'outline': '#9E00CC'},
            "INSTITUTION": {'fill': '#004DA8', 'outline': '#003D86'},
            "MIXED USE": {'fill': '#FFAA00', 'outline': '#CC8800'},
            "MIXED_USE": {'fill': '#FFAA00', 'outline': '#CC8800'},
            "NALA": {'fill': '#002673', 'outline': '#001E5C'},
            "PARK": {'fill': '#AAFF00', 'outline': '#88CC00'},
            "POND": {'fill': '#0070FF', 'outline': '#005ACC'},
            "RECREATIONAL GREEN": {'fill': '#38A800', 'outline': '#2D8600'},
            "RECREATIONAL_GREEN": {'fill': '#38A800', 'outline': '#2D8600'},
            "RESIDENTIAL": {'fill': '#FFFF00', 'outline': '#CCCC00'},
            "RIVERFRONT DEVELOPMENT": {'fill': '#00FFC5', 'outline': '#00CCA0'},
            "RIVERFRONT_DEVELOPMENT": {'fill': '#00FFC5', 'outline': '#00CCA0'},
            "ROADS": {'fill': '#828282', 'outline': '#686868'},
            "SDZ": {'fill': '#E8BEFF', 'outline': '#BA98CC'},
            "SECTOR19 22": {'fill': '#FFFF00', 'outline': '#CCCC00'},
            "SECTOR19_22": {'fill': '#FFFF00', 'outline': '#CCCC00'},
            "TRAFFIC ISLANDS": {'fill': '#55FF00', 'outline': '#44CC00'},
            "TRAFFIC_ISLANDS": {'fill': '#55FF00', 'outline': '#44CC00'},
            "TRANSPORT": {'fill': '#B2B2B2', 'outline': '#8F8F8F'},
            "VILLAGE": {'fill': '#E64C00', 'outline': '#B83D00'},
            "YAMUNA": {'fill': '#005CE6', 'outline': '#0049B8'},
            # Layer-name fallbacks
            "YEIDA ZONES AGRICULTURE": {'fill': '#ABE066', 'outline': '#8AB052'},
            "YEIDA ZONES CANAL": {'fill': '#0070FF', 'outline': '#005ACC'},
            "YEIDA ZONES CANAL GREENBELT": {'fill': '#55FF00', 'outline': '#44CC00'},
            "YEIDA ZONES COMMERCIAL": {'fill': '#E60000', 'outline': '#B80000'},
            "YEIDA ZONES DRAIN": {'fill': '#B5CBFD', 'outline': '#91A3CA'},
            "YEIDA ZONES DRAIN GREENBELT": {'fill': '#55FF00', 'outline': '#44CC00'},
            "YEIDA ZONES FACILITY": {'fill': '#004DA8', 'outline': '#003D86'},
            "YEIDA ZONES FOREST": {'fill': '#55FF00', 'outline': '#44CC00'},
            "YEIDA ZONES GREEN BELT": {'fill': '#55FF00', 'outline': '#44CC00'},
            "YEIDA ZONES INDUSTRY": {'fill': '#C500FF', 'outline': '#9E00CC'},
            "YEIDA ZONES INSTITUTION": {'fill': '#004DA8', 'outline': '#003D86'},
            "YEIDA ZONES MIXED USE": {'fill': '#FFAA00', 'outline': '#CC8800'},
            "YEIDA ZONES NALA": {'fill': '#002673', 'outline': '#001E5C'},
            "YEIDA ZONES PARK": {'fill': '#AAFF00', 'outline': '#88CC00'},
            "YEIDA ZONES POND": {'fill': '#0070FF', 'outline': '#005ACC'},
            "YEIDA ZONES RECREATIONAL GREEN": {'fill': '#38A800', 'outline': '#2D8600'},
            "YEIDA ZONES RESIDENTIAL": {'fill': '#FFFF00', 'outline': '#CCCC00'},
            "YEIDA ZONES RIVERFRONT DEVELOPMENT": {'fill': '#00FFC5', 'outline': '#00CCA0'},
            "YEIDA ZONES ROADS": {'fill': '#828282', 'outline': '#686868'},
            "YEIDA ZONES SDZ": {'fill': '#E8BEFF', 'outline': '#BA98CC'},
            "YEIDA ZONES TRAFFIC ISLANDS": {'fill': '#55FF00', 'outline': '#44CC00'},
            "YEIDA ZONES TRANSPORT": {'fill': '#B2B2B2', 'outline': '#8F8F8F'},
            "YEIDA ZONES VILLAGE": {'fill': '#E64C00', 'outline': '#B83D00'},
            "YEIDA ZONES YAMUNA": {'fill': '#005CE6', 'outline': '#0049B8'},
        }
    ...
    def load_geojson_files(self):
        """Load all Yamuna Expressway GeoJSON files"""
        print("\n" + "="*80)
        print("LOADING YAMUNA EXPRESSWAY GEOJSON DATA")
        print("="*80)
    ...
    def create_pattern(self, draw, poly, base, ptype, pcolor, img_size):
        ...
        if ptype == "hatch":
            ...
            # Draw airplane pattern (cross pattern)
            for y in range(min_y, max_y + 1, spacing):
                for x in range(min_x, max_x + 1, spacing):
                    if min_x <= x <= max_x and min_y <= y <= max_y:
                        # Draw cross pattern
    ...
    def render_tile_seamless(self, tile):
        """
        SEAMLESS RENDERING for Yamuna Expressway:
    ...
    def generate_tiles(self, min_zoom=7, max_zoom=18):
        """Generate seamless tiles for Yamuna Expressway"""
        print(f"\n{'='*80}")
        print(f"GENERATING YAMUNA EXPRESSWAY TILES (Zoom {min_zoom}-{max_zoom})")
    ...
    def generate_html_viewer(self):
        """Generate viewer for Yamuna Expressway"""
        bounds = self.get_bounds()
...
<head>
  <meta charset="utf-8" />
  <title>Yamuna Expressway Master Plan - Seamless Tiles</title>
...
<body>
  ...
  <script>
    ...
    L.tileLayer('./{{z}}/{{x}}/{{y}}.png', {{
      ...
      maxZoom: 18,
      opacity: 0.9,
      attribution: 'Yamuna Expressway Master Plan'
    }}).addTo(map);
    
    const info = L.control({{position: 'topright'}});
    info.onAdd = function() {{
      this._div = L.DomUtil.create('div', 'info');
      this._div.innerHTML = '<b>Yamuna Expressway Master Plan</b><br/>Seamless tiles - no boundaries<br/>Zoom: ' + map.getZoom();
      return this._div;
    }};
    info.addTo(map);
    
    map.on('zoomend', function() {{
      info._div.innerHTML = '<b>Yamuna Expressway Master Plan</b><br/>Seamless tiles - no boundaries<br/>Zoom: ' + map.getZoom();
    }});
  </script>
</body>
</html>"""
...
def main():
    ...
    possible_paths = [
        Path('data/delhi_ncr/yamuna_expressway/master_plan'),
        Path('/Users/rohitboni/Downloads/All_files/project/1acre/geomapping_full/geomapping/data/delhi_ncr/yamuna_expressway/master_plan'),
    ]
    ...
    if data_dir is None:
        print("Enter path to Yamuna Expressway master_plan directory:")
    ...
    output_dir = Path('./yamuna_expressway_tiles_seamless')
    
    print("="*80)
    print("YAMUNA EXPRESSWAY MASTER PLAN - SEAMLESS TILE GENERATOR")
    print("✅ Properly handles polygon holes/interior rings")
    print("="*80)
    print(f"Input:  {data_dir}")
    print(f"Output: {output_dir}")
    
    generator = YamunaExpresswaySeamlessTiles(data_dir, output_dir)
    ...
    print(f"\n💡 To view: cd {output_dir} && python3 -m http.server 8003")
