#!/usr/bin/env python3
"""
Dedicated script to generate high-quality PNG tiles from Dadra and Nagar Haveli Masterplan RGBA GeoTIFF
...
class DadraAndNagarHaveliRGBATileGenerator:
    """
    Generate high-quality PNG tiles from Dadra and Nagar Haveli Masterplan RGBA GeoTIFF
    """
    ...
    def __init__(self, data_dir: str = "data/dadra-nagar-haveli-daman-diu/dadra-nagar-haveli-daman-diu/dadra_and_nagar_haveli_masterplan",
        ...
        logger.info("Dadra and Nagar Haveli RGBA Tile Generator initialized")
    ...
    def generate_tiles(self, min_zoom=8, max_zoom=16):
        """Generate PNG tiles for Dadra and Nagar Haveli Masterplan"""
        ...
        logger.info(f"Generated {total_tiles} PNG tiles for Dadra and Nagar Haveli Masterplan")
    ...
    def create_supporting_files(self, bounds, min_zoom, max_zoom):
        ...
        style_json = {
            "version": 8,
            "name": "Dadra and Nagar Haveli - Masterplan",
            "sources": {
        ...
        tilejson = {
            "tilejson": "2.2.0",
            "name": "Dadra and Nagar Haveli - Masterplan",
            "description": "Master plan tiles for Dadra and Nagar Haveli",
            "version": "1.0.0",
...
<html>
<head>
    <title>Dadra and Nagar Haveli - Masterplan</title>
...
def main():
    """Main function"""
    logger.info("Starting Dadra and Nagar Haveli RGBA Masterplan tile generation")
    
    # Initialize generator
    generator = DadraAndNagarHaveliRGBATileGenerator()
    
    # Generate tiles with higher zoom levels for better quality
    generator.generate_tiles(min_zoom=5, max_zoom=18)
    
    logger.info("Dadra and Nagar Haveli RGBA Masterplan tile generation completed!")
