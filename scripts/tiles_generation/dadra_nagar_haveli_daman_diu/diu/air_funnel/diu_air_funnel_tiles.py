#!/usr/bin/env python3
"""
Diu Air Funnel Zones Tile Generator
...
class DiuAirFunnelTileGenerator:
    ...
    def get_color_map(self):
        """Color mapping for height restriction zones (Diu)"""
        return {
            'For construction mandatory NOC from AAI is required': {'fill': '#91302D', 'outline': '#6B2421'},
            '39 Meters Above Mean Sea Level': {'fill': '#559B33', 'outline': '#3F7326'},
            '49 Meters Above Mean Sea Level': {'fill': '#8B36A4', 'outline': '#682881'},
            '59 Meters Above Mean Sea Level': {'fill': '#CF9D2C', 'outline': '#A37D23'},
            '89 Meters Above Mean Sea Level': {'fill': '#3A6A99', 'outline': '#2C5073'},
            '119 Meters Above Mean Sea Level': {'fill': '#BFC040', 'outline': '#8F9030'},
            '149 Meters Above Mean Sea Level': {'fill': '#A0A0A0', 'outline': '#787878'},
        }
...
<head>
  ...
  <title>Diu Air Funnel Zones Viewer</title>
...
<body>
  ...
  <div class="info-box">
    <strong>Diu Air Funnel Zones</strong><br>
  ...
  <div class="legend">
    ...
    <div class="legend-item">
      ...
      <span style="font-size: 10px;">59m</span>
    </div>
    <div class="legend-item">
      <div class="legend-color" style="background-color: #3A6A99;"></div>
      <span style="font-size: 10px;">89m</span>
    </div>
    <div class="legend-item">
...
def main():
    """Main function"""
    print("=== Diu Air Funnel Zones Tile Generator ===")
    ...
    try:
        # Paths
        data_path = project_root / "data" / "dadra-nagar-haveli-daman-diu" / "daman-and-diu" / "air_funnel_zones" / "Diu.geojson"
        output_dir = project_root / "diu_air_funnel_tiles"
        
        # Initialize generator
        generator = DiuAirFunnelTileGenerator(
            data_path=data_path,
