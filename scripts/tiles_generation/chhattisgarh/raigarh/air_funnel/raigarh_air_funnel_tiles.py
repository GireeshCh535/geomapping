#!/usr/bin/env python3
"""
Raigarh Air Funnel Zones Tile Generator
...
class RaigarhAirFunnelTileGenerator:
    ...
    def get_color_map(self):
        """Color mapping for height restriction zones (Raigarh)"""
        return {
            'For construction mandatory NOC from AAI is required': {'fill': '#91302D', 'outline': '#6B2421'},
            '265 Meters Above Mean Sea Level': {'fill': '#559B33', 'outline': '#3F7326'},
            '385 Meters Above Mean Sea Level': {'fill': '#A0A0A0', 'outline': '#787878'},
        }
...
def main():
    ...
    try:
        # Paths
        data_path = project_root / "data" / "chhatisgarh" / "raigarh" / "air_funnel_zones" / "Raigarh.geojson"
