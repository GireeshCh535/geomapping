#!/usr/bin/env python3
"""
Raipur Air Funnel Zones Tile Generator
...
class RaipurAirFunnelTileGenerator:
    ...
    def get_color_map(self):
        """Color mapping for height restriction zones (Raipur)"""
        return {
            'For construction mandatory NOC from AAI is required': {'fill': '#91302D', 'outline': '#6B2421'},
            '327 Meters Above Mean Sea Level': {'fill': '#559B33', 'outline': '#3F7326'},
            '332 Meters Above Mean Sea Level': {'fill': '#8B36A4', 'outline': '#682881'},
            '337 Meters Above Mean Sea Level': {'fill': '#C157D9', 'outline': '#9333B3'},
            '342 Meters Above Mean Sea Level': {'fill': '#CF9D2C', 'outline': '#A37D23'},
            '347 Meters Above Mean Sea Level': {'fill': '#F2B02C', 'outline': '#B88522'},
            '352 Meters Above Mean Sea Level': {'fill': '#3A6A99', 'outline': '#2C5073'},
            '357 Meters Above Mean Sea Level': {'fill': '#5F84B1', 'outline': '#476385'},
            '367 Meters Above Mean Sea Level': {'fill': '#BFC040', 'outline': '#8F9030'},
            '397 Meters Above Mean Sea Level': {'fill': '#DED92E', 'outline': '#A8A523'},
            '427 Meters Above Mean Sea Level': {'fill': '#AA8F9D', 'outline': '#806A75'},
            '457 Meters Above Mean Sea Level': {'fill': '#A0A0A0', 'outline': '#787878'},
        }
...
def main():
    ...
    try:
        # Paths
        data_path = project_root / "data" / "chhatisgarh" / "new-raipur" / "air_funnel_zones" / "Raipur.geojson"
