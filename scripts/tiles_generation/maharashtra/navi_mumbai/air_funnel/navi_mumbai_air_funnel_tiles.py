#!/usr/bin/env python3
"""
Navi Mumbai Air Funnel Zones Tile Generator
...
class NaviMumbaiAirFunnelTileGenerator:
    ...
    def get_color_map(self):
        """Color mapping for height restriction zones (Navi Mumbai)"""
        return {
            'For construction mandatory NOC from AAI is required': {'fill': '#91302D', 'outline': '#6B2421'},
            '22 Meters Above Mean Sea Level': {'fill': '#559B33', 'outline': '#3F7326'},
            '30 Meters Above Mean Sea Level': {'fill': '#8B36A4', 'outline': '#682881'},
            '40 Meters Above Mean Sea Level': {'fill': '#CF9D2C', 'outline': '#A37D23'},
            '60 Meters Above Mean Sea Level': {'fill': '#3A6A99', 'outline': '#2C5073'},
            '90 Meters Above Mean Sea Level': {'fill': '#BFC040', 'outline': '#8F9030'},
            '120 Meters Above Mean Sea Level': {'fill': '#AA8F9D', 'outline': '#806A75'},
            '150 Meters Above Mean Sea Level': {'fill': '#A0A0A0', 'outline': '#787878'},
        }
...
def main():
    ...
    try:
        # Paths
        data_path = project_root / "data" / "maharashtra" / "mumbai" / "air_funnel_zones" / "Navi_Mumbai.geojson"
        output_dir = project_root / "navi_mumbai_air_funnel_tiles"
        
        # Initialize generator
        generator = NaviMumbaiAirFunnelTileGenerator(
            data_path=data_path,
