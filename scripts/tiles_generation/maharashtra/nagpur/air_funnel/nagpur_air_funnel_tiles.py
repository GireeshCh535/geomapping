#!/usr/bin/env python3
"""
Nagpur Air Funnel Zones Tile Generator
...
class NagpurAirFunnelTileGenerator:
    ...
    def get_color_map(self):
        """Color mapping for height restriction zones (Nagpur)"""
        return {
            'For construction mandatory NOC from AAI is required': {'fill': '#91302D', 'outline': '#6B2421'},
            '335 Meters Above Mean Sea Level': {'fill': '#559B33', 'outline': '#3F7326'},
            '345 Meters Above Mean Sea Level': {'fill': '#8B36A4', 'outline': '#682881'},
            '355 Meters Above Mean Sea Level': {'fill': '#CF9D2C', 'outline': '#A37D23'},
            '375 Meters Above Mean Sea Level': {'fill': '#3A6A99', 'outline': '#2C5073'},
            '395 Meters Above Mean Sea Level': {'fill': '#BFC040', 'outline': '#8F9030'},
            '415 Meters Above Mean Sea Level': {'fill': '#A0A0A0', 'outline': '#787878'},
        }
...
def main():
    ...
    try:
        # Paths
        data_path = project_root / "data" / "maharashtra" / "nagpur" / "air_funnel_zones" / "Nagpur.geojson"
