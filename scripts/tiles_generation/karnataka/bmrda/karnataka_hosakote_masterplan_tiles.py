#!/usr/bin/env python3
"""
Dedicated script to generate high-quality PNG tiles from Hosakote Masterplan RGBA GeoTIFF
...
class HosakoteMasterplanTileGenerator:
    """
    Generate high-quality PNG tiles from Hosakote Masterplan RGBA GeoTIFF
    """
    ...
    def __init__(self, data_dir: str = "data/karnataka/BMRDA/Hosakote Masterplan",
        ...
        logger.info("Hosakote Masterplan Tile Generator initialized")
    ...
    def generate_tiles(self, min_zoom=8, max_zoom=16):
        """Generate PNG tiles for Hosakote Masterplan"""
        ...
        logger.info(f"Generated {total_tiles} PNG tiles for Hosakote Masterplan")
    ...
    def create_supporting_files(self, bounds, min_zoom, max_zoom):
        ...
        style_json = {
            "version": 8,
            "name": "Karnataka BMRDA - Hosakote Masterplan",
            "sources": {
                "hosakote-masterplan": {
                    "type": "raster",
                    "tiles": [
        ...
        tilejson = {
            "tilejson": "2.2.0",
            "name": "Karnataka BMRDA - Hosakote Masterplan",
            "description": "Master plan tiles for Karnataka BMRDA - Hosakote",
            "version": "1.0.0",
            "attribution": "BMRDA",
            "template": "",
            "legend": "",
...
<html>
<head>
    <title>Karnataka BMRDA - Hosakote Masterplan</title>
...
def main():
    """Main function"""
    logger.info("Starting Hosakote Masterplan tile generation")
    
    # Initialize generator
    generator = HosakoteMasterplanTileGenerator()
    
    # Generate tiles with higher zoom levels for better quality
    generator.generate_tiles(min_zoom=8, max_zoom=16)
    
    logger.info("Hosakote Masterplan tile generation completed!")
