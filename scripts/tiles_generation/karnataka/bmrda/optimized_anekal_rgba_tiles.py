#!/usr/bin/env python3
"""
Optimized script to generate high-quality PNG tiles from Anekal Masterplan RGBA GeoTIFF
...
class OptimizedAnekalRGBATileGenerator:
    """
    Generate high-quality PNG tiles from Anekal Masterplan RGBA GeoTIFF with optimized performance
    """
    ...
    def __init__(self, data_dir: str = "data/karnataka/BMRDA/Anekal Masterplan",
        ...
        logger.info(f"Anekal RGBA Tile Generator initialized with {self.max_workers} workers")
    ...
    def generate_tiles(self, min_zoom=8, max_zoom=16):
        """Generate PNG tiles for Anekal Masterplan with optimized performance"""
        ...
        logger.info(f"Generated {total_tiles} PNG tiles for Anekal Masterplan in {duration:.2f} seconds")
    ...
    def create_supporting_files(self, bounds, min_zoom, max_zoom):
        ...
        style_json = {
            "version": 8,
            "name": "Karnataka BMRDA - Anekal Masterplan (Optimized)",
            "sources": {
                "anekal-masterplan": {
                    "type": "raster",
                    "tiles": [
        ...
        tilejson = {
            "tilejson": "2.2.0",
            "name": "Karnataka BMRDA - Anekal Masterplan (Optimized)",
            "description": "Master plan tiles for Karnataka BMRDA - Anekal (Optimized for performance)",
            "version": "1.0.0",
            "attribution": "BMRDA",
            "template": "",
            "legend": "",
...
<html>
<head>
    <title>Karnataka BMRDA - Anekal Masterplan (Optimized)</title>
...
def main():
    """Main function"""
    logger.info("Starting Optimized Anekal RGBA Masterplan tile generation")
    
    # Initialize generator with optimized settings
    generator = OptimizedAnekalRGBATileGenerator(max_workers=8)
    
    # Generate tiles with higher zoom levels for better quality
    generator.generate_tiles(min_zoom=17, max_zoom=18)
    
    logger.info("Optimized Anekal RGBA Masterplan tile generation completed!")
