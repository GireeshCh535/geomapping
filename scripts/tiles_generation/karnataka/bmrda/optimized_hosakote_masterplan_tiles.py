#!/usr/bin/env python3
"""
Optimized script to generate high-quality PNG tiles from Hosakote Masterplan RGBA GeoTIFF
...
class OptimizedHosakoteMasterplanTileGenerator:
    """
    Generate high-quality PNG tiles from Hosakote Masterplan RGBA GeoTIFF with optimized performance
    """
    
    def __init__(self, data_dir: str = "data/karnataka/BMRDA/Hosakote Masterplan",
                 output_dir: str = "hosakote_masterplan_tiles",
        ...
        logger.info(f"Hosakote Masterplan Tile Generator initialized with {self.max_workers} workers")
    ...
    def generate_tiles(self, min_zoom=8, max_zoom=16):
        """Generate PNG tiles for Hosakote Masterplan with optimized performance"""
        ...
        logger.info(f"Generated {total_tiles} PNG tiles for Hosakote Masterplan in {duration:.2f} seconds")
    ...
    def create_supporting_files(self, bounds, min_zoom, max_zoom):
        ...
        style_json = {
            "version": 8,
            "name": "Karnataka BMRDA - Hosakote Masterplan (Optimized)",
            "sources": {
                "hosakote-masterplan": {
                    "type": "raster",
                    "tiles": [
                        "https://d17yosovmfjm4.cloudfront.net/karnataka/bmrda/hosakote_masterplan/{z}/{x}/{y}.png"
                    ],
                    "tileSize": 256
                }
            },
            "layers": [
                {
                    "id": "hosakote-masterplan-layer",
                    "type": "raster",
                    "source": "hosakote-masterplan",
                    "paint": {
                        "raster-opacity": 0.8
                    }
                }
        ...
        tilejson = {
            "tilejson": "2.2.0",
            "name": "Karnataka BMRDA - Hosakote Masterplan (Optimized)",
            "description": "Master plan tiles for Karnataka BMRDA - Hosakote (Optimized for performance)",
            "version": "1.0.0",
            "attribution": "BMRDA",
            "template": "",
            "legend": "",
...
<html>
<head>
    <title>Karnataka BMRDA - Hosakote Masterplan (Optimized)</title>
...
def main():
    """Main function"""
    logger.info("Starting Optimized Hosakote Masterplan tile generation")
    
    # Initialize generator with optimized settings
    generator = OptimizedHosakoteMasterplanTileGenerator(max_workers=8)
    
    # Generate tiles with higher zoom levels for better quality
    generator.generate_tiles(min_zoom=17, max_zoom=18)
    
    logger.info("Optimized Hosakote Masterplan tile generation completed!")
