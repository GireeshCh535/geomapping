#!/usr/bin/env python3
"""
Dedicated script to generate high-quality PNG tiles from Chikkaballapura Masterplan RGBA GeoTIFF
...
class ChikkaballapuraMasterplanTileGenerator:
    """
    Generate high-quality PNG tiles from Chikkaballapura Masterplan RGBA GeoTIFF
    """
    ...
    def __init__(self, data_dir: str = "data/karnataka/BMRDA/Chikkaballapura Masterplan",
        ...
        logger.info("Chikkaballapura Masterplan Tile Generator initialized")
    ...
    def generate_tiles(self, min_zoom=8, max_zoom=16):
        """Generate PNG tiles for Chikkaballapura Masterplan"""
        ...
        logger.info(f"Generated {total_tiles} PNG tiles for Chikkaballapura Masterplan")
    ...
    def create_supporting_files(self, bounds, min_zoom, max_zoom):
        ...
        style_json = {
            "version": 8,
            "name": "Karnataka BMRDA - Chikkaballapura Masterplan",
            "sources": {
        ...
        tilejson = {
            "tilejson": "2.2.0",
            "name": "Karnataka BMRDA - Chikkaballapura Masterplan",
            "description": "Master plan tiles for Karnataka BMRDA - Chikkaballapura",
            "version": "1.0.0",
            "attribution": "BMRDA",
            "template": "",
            "legend": "",
...
<html>
<head>
    <title>Karnataka BMRDA - Chikkaballapura Masterplan</title>
...
def main():
    """Main function"""
    logger.info("Starting Chikkaballapura Masterplan tile generation")
    
    # Initialize generator
    generator = ChikkaballapuraMasterplanTileGenerator()
    
    # Generate tiles with higher zoom levels for better quality
    generator.generate_tiles(min_zoom=17, max_zoom=18)
    
    logger.info("Chikkaballapura Masterplan tile generation completed!")
