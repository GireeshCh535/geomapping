#!/usr/bin/env python3
"""
Dedicated script to generate high-quality PNG tiles from Nelamangala Sompura Masterplan RGBA GeoTIFF
...
class NelamangalaMasterplanTileGenerator:
    """
    Generate high-quality PNG tiles from Nelamangala Sompura Masterplan RGBA GeoTIFF
    """
    ...
    def generate_tiles(self, min_zoom=8, max_zoom=16):
        """Generate PNG tiles for Nelamangala Sompura Masterplan"""
    ...
    def create_supporting_files(self, bounds, min_zoom, max_zoom):
        ...
        style_json = {
            "version": 8,
            "name": "Karnataka BMRDA - Nelamangala Sompura Masterplan",
            "sources": {
        ...
        tilejson = {
            "tilejson": "2.2.0",
            "name": "Karnataka BMRDA - Nelamangala Sompura Masterplan",
            "description": "Master plan tiles for Karnataka BMRDA - Nelamangala Sompura",
            "version": "1.0.0",
            "attribution": "BMRDA",
            "template": "",
            "legend": "",
...
<html>
<head>
    <title>Karnataka BMRDA - Nelamangala Sompura Masterplan</title>
...
def main():
    ...
    generator.generate_tiles(min_zoom=10, max_zoom=14)
