#!/usr/bin/env python3
"""
Calicut (Kozhikode) Air Funnel Zones Tile Generator
...
class CalicutAirFunnelTileGenerator:
...
<head>
  ...
  <title>Calicut Air Funnel Zones Viewer</title>
...
<body>
  <div id="map"></div>
  <div class="info-box">
    <strong>Calicut Air Funnel Zones</strong><br>
...
def main():
    print("=== Calicut Air Funnel Zones Tile Generator ===")
    print("Generating tiles for airport height restriction zones\n")
    
    settings = DEFAULT_VIEW_SETTINGS
    
    try:
        data_path = project_root / "data" / "arifunnel" / "Calicut.geojson"
        output_dir = project_root / "calicut_air_funnel_tiles"
        
        generator = CalicutAirFunnelTileGenerator(
            data_path=data_path,
