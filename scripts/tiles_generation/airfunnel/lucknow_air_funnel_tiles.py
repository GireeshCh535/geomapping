#!/usr/bin/env python3
"""
Lucknow (Kozhikode) Air Funnel Zones Tile Generator
...
class LucknowAirFunnelTileGenerator:
    ...
    def get_color_map(self):
        ...
        return {
            ...
            '140 Meters Above Mean Sea Level': {'fill': '#559B33', 'outline': '#447c28'},
            '160 Meters Above Mean Sea Level': {'fill': '#8B36A4', 'outline': '#6f2b83'},
            '180 Meters Above Mean Sea Level': {'fill': '#CF9D2C', 'outline': '#a57d23'},
            '200 Meters Above Mean Sea Level': {'fill': '#3A6A99', 'outline': '#2e547a'},
            '220 Meters Above Mean Sea Level': {'fill': '#A0A0A0', 'outline': '#808080'},
        }
...
def main():
    ...
    try:
        data_path = project_root / "data" / "arifunnel" / "Lucknow.geojson"
