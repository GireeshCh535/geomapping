#!/usr/bin/env python3
"""
Chennai (Kozhikode) Air Funnel Zones Tile Generator
...
class ChennaiAirFunnelTileGenerator:
    ...
    def get_color_map(self):
        ...
        return {
            ...
            '26 Meters Above Mean Sea Level': {'fill': '#559B33', 'outline': '#447c28'},
            '31 Meters Above Mean Sea Level': {'fill': '#7EBC4F', 'outline': '#64963f'},
            '36 Meters Above Mean Sea Level': {'fill': '#8B36A4', 'outline': '#6f2b83'},
            '46 Meters Above Mean Sea Level': {'fill': '#C157D9', 'outline': '#9a45ad'},
            '56 Meters Above Mean Sea Level': {'fill': '#CF9D2C', 'outline': '#a57d23'},
            '66 Meters Above Mean Sea Level': {'fill': '#F2B02C', 'outline': '#c18c23'},
            '96 Meters Above Mean Sea Level': {'fill': '#3A6A99', 'outline': '#2e547a'},
            '126 Meters Above Mean Sea Level': {'fill': '#BFC040', 'outline': '#989933'},
            '156 Meters Above Mean Sea Level': {'fill': '#A0A0A0', 'outline': '#808080'},
        }
...
<head>
  ...
  <title>Chennai Air Funnel Zones Viewer</title>
...
<body>
  <div id="map"></div>
  <div class="info-box">
    <strong>Chennai Air Funnel Zones</strong><br>
...
def main():
    print("=== Chennai Air Funnel Zones Tile Generator ===")
    print("Generating tiles for airport height restriction zones\n")
    
    settings = DEFAULT_VIEW_SETTINGS
    
    try:
        data_path = project_root / "data" / "arifunnel" / "Chennai.geojson"
        output_dir = project_root / "chennai_air_funnel_tiles"
        
        generator = ChennaiAirFunnelTileGenerator(
            data_path=data_path,
