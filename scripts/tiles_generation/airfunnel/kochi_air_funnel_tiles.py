#!/usr/bin/env python3
"""
Kochi (Kozhikode) Air Funnel Zones Tile Generator
...
class KochiAirFunnelTileGenerator:
    ...
    def get_color_map(self):
        ...
        return {
            ...
            '19 Meters Above Mean Sea Level': {'fill': '#559B33', 'outline': '#447c28'},
            '29 Meters Above Mean Sea Level': {'fill': '#8B36A4', 'outline': '#6f2b83'},
            '39 Meters Above Mean Sea Level': {'fill': '#CF9D2C', 'outline': '#a57d23'},
            '49 Meters Above Mean Sea Level': {'fill': '#3A6A99', 'outline': '#2e547a'},
            '119 Meters Above Mean Sea Level': {'fill': '#AA8F9D', 'outline': '#88727d'},
...
<head>
  ...
  <title>Kochi Air Funnel Zones Viewer</title>
...
<body>
  <div id="map"></div>
  <div class="info-box">
    <strong>Kochi Air Funnel Zones</strong><br>
...
def main():
    print("=== Kochi Air Funnel Zones Tile Generator ===")
    print("Generating tiles for airport height restriction zones\n")
    
    settings = DEFAULT_VIEW_SETTINGS
    
    try:
        data_path = project_root / "data" / "arifunnel" / "Kochi.geojson"
        output_dir = project_root / "kochi_air_funnel_tiles"
        
        generator = KochiAirFunnelTileGenerator(
            data_path=data_path,
