#!/usr/bin/env python3
"""
Guwahati (Kozhikode) Air Funnel Zones Tile Generator
...
class GuwahatiAirFunnelTileGenerator:
    ...
    def get_color_map(self):
        ...
        return {
            ...
            '64 Meters Above Mean Sea Level': {'fill': '#559B33', 'outline': '#447c28'},
            '69 Meters Above Mean Sea Level': {'fill': '#7EBC4F', 'outline': '#64963f'},
            '79 Meters Above Mean Sea Level': {'fill': '#8B36A4', 'outline': '#6f2b83'},
            '159 Meters Above Mean Sea Level': {'fill': '#CF9D2C', 'outline': '#a57d23'},
            '189 Meters Above Mean Sea Level': {'fill': '#A0A0A0', 'outline': '#808080'},
        }
...
<head>
  ...
  <title>Guwahati Air Funnel Zones Viewer</title>
...
<body>
  <div id="map"></div>
  <div class="info-box">
    <strong>Guwahati Air Funnel Zones</strong><br>
...
def main():
    print("=== Guwahati Air Funnel Zones Tile Generator ===")
    print("Generating tiles for airport height restriction zones\n")
    
    settings = DEFAULT_VIEW_SETTINGS
    
    try:
        data_path = project_root / "data" / "arifunnel" / "Guwahati.geojson"
        output_dir = project_root / "guwahati_air_funnel_tiles"
        
        generator = GuwahatiAirFunnelTileGenerator(
            data_path=data_path,
