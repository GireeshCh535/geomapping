#!/usr/bin/env python3
"""
Raipur (Kozhikode) Air Funnel Zones Tile Generator
...
class RaipurAirFunnelTileGenerator:
    ...
    def get_color_map(self):
        ...
        return {
            'For construction mandatory NOC from AAI is required': {'fill': '#91302D', 'outline': '#742624'},
            '327 Meters Above Mean Sea Level': {'fill': '#559B33', 'outline': '#447c28'},
            '332 Meters Above Mean Sea Level': {'fill': '#8B36A4', 'outline': '#6f2b83'},
            '337 Meters Above Mean Sea Level': {'fill': '#C157D9', 'outline': '#9a45ad'},
            '342 Meters Above Mean Sea Level': {'fill': '#CF9D2C', 'outline': '#a57d23'},
            '347 Meters Above Mean Sea Level': {'fill': '#F2B02C', 'outline': '#c18c23'},
            '352 Meters Above Mean Sea Level': {'fill': '#3A6A99', 'outline': '#2e547a'},
            '357 Meters Above Mean Sea Level': {'fill': '#5F84B1', 'outline': '#4c698d'},
            '367 Meters Above Mean Sea Level': {'fill': '#BFC040', 'outline': '#989933'},
            '397 Meters Above Mean Sea Level': {'fill': '#DED92E', 'outline': '#b1ad24'},
            '427 Meters Above Mean Sea Level': {'fill': '#AA8F9D', 'outline': '#88727d'},
            '457 Meters Above Mean Sea Level': {'fill': '#A0A0A0', 'outline': '#808080'},
        }
...
<head>
  ...
  <title>Raipur Air Funnel Zones Viewer</title>
...
<body>
  <div id="map"></div>
  <div class="info-box">
    <strong>Raipur Air Funnel Zones</strong><br>
  ...
  <div class="legend">
    ...
    <div class="legend-item">
      ...
      <span style="font-size: 10px;">327m</span>
    </div>
    <div class="legend-item">
      <div class="legend-color" style="background-color: #8B36A4;"></div>
      <span style="font-size: 10px;">332m</span>
    </div>
    <div class="legend-item">
      <div class="legend-color" style="background-color: #C157D9;"></div>
      <span style="font-size: 10px;">337m</span>
    </div>
    <div class="legend-item">
      <div class="legend-color" style="background-color: #CF9D2C;"></div>
      <span style="font-size: 10px;">342m</span>
    </div>
    <div class="legend-item">
      <div class="legend-color" style="background-color: #F2B02C;"></div>
      <span style="font-size: 10px;">347m</span>
    </div>
    <div class="legend-item">
      <div class="legend-color" style="background-color: #3A6A99;"></div>
      <span style="font-size: 10px;">352m</span>
    </div>
    <div class="legend-item">
      <div class="legend-color" style="background-color: #5F84B1;"></div>
      <span style="font-size: 10px;">357m</span>
    </div>
    <div class="legend-item">
      <div class="legend-color" style="background-color: #BFC040;"></div>
      <span style="font-size: 10px;">367m</span>
    </div>
    <div class="legend-item">
      <div class="legend-color" style="background-color: #DED92E;"></div>
      <span style="font-size: 10px;">397m</span>
    </div>
    <div class="legend-item">
      <div class="legend-color" style="background-color: #AA8F9D;"></div>
      <span style="font-size: 10px;">427m</span>
    </div>
    <div class="legend-item">
      <div class="legend-color" style="background-color: #A0A0A0;"></div>
      <span style="font-size: 10px;">457m</span>
    </div>
  </div>
...
def main():
    print("=== Raipur Air Funnel Zones Tile Generator ===")
    print("Generating tiles for airport height restriction zones\n")
    
    settings = DEFAULT_VIEW_SETTINGS
    
    try:
        data_path = project_root / "data" / "arifunnel" / "Raipur.geojson"
        output_dir = project_root / "raipur_air_funnel_tiles"
        
        generator = RaipurAirFunnelTileGenerator(
            data_path=data_path,
