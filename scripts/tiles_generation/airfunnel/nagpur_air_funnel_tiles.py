#!/usr/bin/env python3
"""
Nagpur (Kozhikode) Air Funnel Zones Tile Generator
...
class NagpurAirFunnelTileGenerator:
    ...
    def get_color_map(self):
        ...
        return {
            ...
            '335 Meters Above Mean Sea Level': {'fill': '#559B33', 'outline': '#447c28'},
            '345 Meters Above Mean Sea Level': {'fill': '#8B36A4', 'outline': '#6f2b83'},
            '355 Meters Above Mean Sea Level': {'fill': '#CF9D2C', 'outline': '#a57d23'},
            '375 Meters Above Mean Sea Level': {'fill': '#3A6A99', 'outline': '#2e547a'},
            '395 Meters Above Mean Sea Level': {'fill': '#BFC040', 'outline': '#989933'},
            '415 Meters Above Mean Sea Level': {'fill': '#A0A0A0', 'outline': '#808080'},
        }
...
<head>
  ...
  <title>Nagpur Air Funnel Zones Viewer</title>
...
<body>
  <div id="map"></div>
  <div class="info-box">
    <strong>Nagpur Air Funnel Zones</strong><br>
  ...
  <div class="legend">
    ...
    <div class="legend-item">
      ...
      <span style="font-size: 10px;">335m</span>
    </div>
    <div class="legend-item">
...
def main():
    print("=== Nagpur Air Funnel Zones Tile Generator ===")
    print("Generating tiles for airport height restriction zones\n")
    
    settings = DEFAULT_VIEW_SETTINGS
    
    try:
        data_path = project_root / "data" / "arifunnel" / "Nagpur.geojson"
        output_dir = project_root / "nagpur_air_funnel_tiles"
        
        generator = NagpurAirFunnelTileGenerator(
            data_path=data_path,
