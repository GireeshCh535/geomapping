#!/usr/bin/env python3
"""
Delhi-IGI (Kozhikode) Air Funnel Zones Tile Generator
...
class Delhi-IGIAirFunnelTileGenerator:
    ...
    def get_color_map(self):
        ...
        return {
            ...
            '245 Meters Above Mean Sea Level': {'fill': '#559B33', 'outline': '#447c28'},
            '255 Meters Above Mean Sea Level': {'fill': '#7EBC4F', 'outline': '#64963f'},
            '265 Meters Above Mean Sea Level': {'fill': '#8B36A4', 'outline': '#6f2b83'},
            '285 Meters Above Mean Sea Level': {'fill': '#C157D9', 'outline': '#9a45ad'},
            '295 Meters Above Mean Sea Level': {'fill': '#CF9D2C', 'outline': '#a57d23'},
            '315 Meters Above Mean Sea Level': {'fill': '#F2B02C', 'outline': '#c18c23'},
            '325 Meters Above Mean Sea Level': {'fill': '#3A6A99', 'outline': '#2e547a'},
            '345 Meters Above Mean Sea Level': {'fill': '#5F84B1', 'outline': '#4c698d'},
            '355 Meters Above Mean Sea Level': {'fill': '#A0A0A0', 'outline': '#808080'},
        }
...
<head>
  ...
  <title>Delhi-IGI Air Funnel Zones Viewer</title>
...
<body>
  <div id="map"></div>
  <div class="info-box">
    <strong>Delhi-IGI Air Funnel Zones</strong><br>
...
def main():
    print("=== Delhi-IGI Air Funnel Zones Tile Generator ===")
    print("Generating tiles for airport height restriction zones\n")
    
    settings = DEFAULT_VIEW_SETTINGS
    
    try:
        data_path = project_root / "data" / "arifunnel" / "Delhi-IGI.geojson"
        output_dir = project_root / "delhi_igi_air_funnel_tiles"
        
        generator = Delhi-IGIAirFunnelTileGenerator(
            data_path=data_path,
