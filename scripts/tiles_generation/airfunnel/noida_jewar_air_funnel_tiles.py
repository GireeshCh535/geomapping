#!/usr/bin/env python3
"""
Noida-Jewar (Kozhikode) Air Funnel Zones Tile Generator
...
class Noida-JewarAirFunnelTileGenerator:
    ...
    def get_color_map(self):
        ...
        return {
            ...
            '214 Meters Above Mean Sea Level': {'fill': '#559B33', 'outline': '#447c28'},
            '219 Meters Above Mean Sea Level': {'fill': '#7EBC4F', 'outline': '#64963f'},
            '229 Meters Above Mean Sea Level': {'fill': '#8B36A4', 'outline': '#6f2b83'},
            '239 Meters Above Mean Sea Level': {'fill': '#C157D9', 'outline': '#9a45ad'},
            '249 Meters Above Mean Sea Level': {'fill': '#CF9D2C', 'outline': '#a57d23'},
            '279 Meters Above Mean Sea Level': {'fill': '#3A6A99', 'outline': '#2e547a'},
            '309 Meters Above Mean Sea Level': {'fill': '#BFC040', 'outline': '#989933'},
            '339 Meters Above Mean Sea Level': {'fill': '#A0A0A0', 'outline': '#808080'},
        }
...
<head>
  ...
  <title>Noida-Jewar Air Funnel Zones Viewer</title>
...
<body>
  <div id="map"></div>
  <div class="info-box">
    <strong>Noida-Jewar Air Funnel Zones</strong><br>
...
def main():
    print("=== Noida-Jewar Air Funnel Zones Tile Generator ===")
    print("Generating tiles for airport height restriction zones\n")
    
    settings = DEFAULT_VIEW_SETTINGS
    
    try:
        data_path = project_root / "data" / "arifunnel" / "Noida-Jewar.geojson"
        output_dir = project_root / "noida_jewar_air_funnel_tiles"
        
        generator = Noida-JewarAirFunnelTileGenerator(
            data_path=data_path,
