#!/usr/bin/env python3
"""
Ahmedabad-Gandhinagar (Kozhikode) Air Funnel Zones Tile Generator
...
class Ahmedabad-GandhinagarAirFunnelTileGenerator:
    ...
    def get_color_map(self):
        ...
        return {
            ...
            '77 Meters Above Mean Sea Level': {'fill': '#559B33', 'outline': '#447c28'},
            '95 Meters Above Mean Sea Level': {'fill': '#8B36A4', 'outline': '#6f2b83'},
            '115 Meters Above Mean Sea Level': {'fill': '#CF9D2C', 'outline': '#a57d23'},
            '135 Meters Above Mean Sea Level': {'fill': '#3A6A99', 'outline': '#2e547a'},
            '155 Meters Above Mean Sea Level': {'fill': '#A0A0A0', 'outline': '#808080'},
        }
...
def main():
    ...
    try:
        data_path = project_root / "data" / "arifunnel" / "Ahmedabad-Gandhinagar.geojson"
        output_dir = project_root / "ahmedabad_gandhinagar_air_funnel_tiles"
        
        generator = Ahmedabad-GandhinagarAirFunnelTileGenerator(
            data_path=data_path,
