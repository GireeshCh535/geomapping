#!/usr/bin/env python3
"""
Bhubaneswar (Kozhikode) Air Funnel Zones Tile Generator
...
class BhubaneswarAirFunnelTileGenerator:
    ...
    def get_color_map(self):
        ...
        return {
            ...
            '63 Meters Above Mean Sea Level': {'fill': '#8B36A4', 'outline': '#6f2b83'},
            '183 Meters Above Mean Sea Level': {'fill': '#A0A0A0', 'outline': '#808080'},
        }
...
<head>
  ...
  <title>Bhubaneswar Air Funnel Zones Viewer</title>
...
<body>
  <div id="map"></div>
  <div class="info-box">
    <strong>Bhubaneswar Air Funnel Zones</strong><br>
  ...
  <div class="legend">
    ...
    <div class="legend-item">
      ...
      <span style="font-size: 10px;">63m</span>
    </div>
    <div class="legend-item">
      <div class="legend-color" style="background-color: #A0A0A0;"></div>
      <span style="font-size: 10px;">183m</span>
    </div>
  </div>
...
def main():
    print("=== Bhubaneswar Air Funnel Zones Tile Generator ===")
    print("Generating tiles for airport height restriction zones\n")
    
    settings = DEFAULT_VIEW_SETTINGS
    
    try:
        data_path = project_root / "data" / "arifunnel" / "Bhubaneswar.geojson"
        output_dir = project_root / "bhubaneswar_air_funnel_tiles"
        
        generator = BhubaneswarAirFunnelTileGenerator(
            data_path=data_path,
