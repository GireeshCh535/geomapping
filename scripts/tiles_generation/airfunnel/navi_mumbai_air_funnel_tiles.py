#!/usr/bin/env python3
"""
Navi-Mumbai (Kozhikode) Air Funnel Zones Tile Generator
...
class Navi-MumbaiAirFunnelTileGenerator:
    ...
    def get_color_map(self):
        ...
        return {
            ...
            '22 Meters Above Mean Sea Level': {'fill': '#559B33', 'outline': '#447c28'},
            '30 Meters Above Mean Sea Level': {'fill': '#8B36A4', 'outline': '#6f2b83'},
            '40 Meters Above Mean Sea Level': {'fill': '#CF9D2C', 'outline': '#a57d23'},
            '60 Meters Above Mean Sea Level': {'fill': '#3A6A99', 'outline': '#2e547a'},
            '90 Meters Above Mean Sea Level': {'fill': '#BFC040', 'outline': '#989933'},
            '120 Meters Above Mean Sea Level': {'fill': '#AA8F9D', 'outline': '#88727d'},
            '150 Meters Above Mean Sea Level': {'fill': '#A0A0A0', 'outline': '#808080'},
        }
...
<head>
  ...
  <title>Navi-Mumbai Air Funnel Zones Viewer</title>
...
<body>
  <div id="map"></div>
  <div class="info-box">
    <strong>Navi-Mumbai Air Funnel Zones</strong><br>
...
def main():
    print("=== Navi-Mumbai Air Funnel Zones Tile Generator ===")
    print("Generating tiles for airport height restriction zones\n")
    
    settings = DEFAULT_VIEW_SETTINGS
    
    try:
        data_path = project_root / "data" / "arifunnel" / "Navi-Mumbai.geojson"
        output_dir = project_root / "navi_mumbai_air_funnel_tiles"
        
        generator = Navi-MumbaiAirFunnelTileGenerator(
            data_path=data_path,
