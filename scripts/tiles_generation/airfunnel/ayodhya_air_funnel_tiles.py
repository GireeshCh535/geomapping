#!/usr/bin/env python3
"""
Ayodhya (Kozhikode) Air Funnel Zones Tile Generator
...
class AyodhyaAirFunnelTileGenerator:
    ...
    def get_color_map(self):
        ...
        return {
            ...
            '110 Meters Above Mean Sea Level': {'fill': '#559B33', 'outline': '#447c28'},
            '120 Meters Above Mean Sea Level': {'fill': '#7EBC4F', 'outline': '#64963f'},
            '130 Meters Above Mean Sea Level': {'fill': '#8B36A4', 'outline': '#6f2b83'},
            '240 Meters Above Mean Sea Level': {'fill': '#A0A0A0', 'outline': '#808080'},
        }
...
<head>
  ...
  <title>Ayodhya Air Funnel Zones Viewer</title>
...
<body>
  <div id="map"></div>
  <div class="info-box">
    <strong>Ayodhya Air Funnel Zones</strong><br>
  ...
  <div class="legend">
    ...
    <div class="legend-item">
      ...
      <span style="font-size: 10px;">110m</span>
    </div>
    <div class="legend-item">
    ...
    <div class="legend-item">
      ...
      <span style="font-size: 10px;">130m</span>
    </div>
    <div class="legend-item">
      <div class="legend-color" style="background-color: #A0A0A0;"></div>
      <span style="font-size: 10px;">240m</span>
    </div>
  </div>
...
def main():
    print("=== Ayodhya Air Funnel Zones Tile Generator ===")
    print("Generating tiles for airport height restriction zones\n")
    
    settings = DEFAULT_VIEW_SETTINGS
    
    try:
        data_path = project_root / "data" / "arifunnel" / "Ayodhya.geojson"
        output_dir = project_root / "ayodhya_air_funnel_tiles"
        
        generator = AyodhyaAirFunnelTileGenerator(
            data_path=data_path,
