#!/usr/bin/env python3
"""
Tirupati (Kozhikode) Air Funnel Zones Tile Generator
...
class TirupatiAirFunnelTileGenerator:
    ...
    def get_color_map(self):
        ...
        return {
            ...
            '137 Meters Above Mean Sea Level': {'fill': '#559B33', 'outline': '#447c28'},
            '147 Meters Above Mean Sea Level': {'fill': '#8B36A4', 'outline': '#6f2b83'},
            '157 Meters Above Mean Sea Level': {'fill': '#CF9D2C', 'outline': '#a57d23'},
            '187 Meters Above Mean Sea Level': {'fill': '#3A6A99', 'outline': '#2e547a'},
            '217 Meters Above Mean Sea Level': {'fill': '#BFC040', 'outline': '#989933'},
            '247 Meters Above Mean Sea Level': {'fill': '#A0A0A0', 'outline': '#808080'},
        }
...
<head>
  ...
  <title>Tirupati Air Funnel Zones Viewer</title>
...
<body>
  <div id="map"></div>
  <div class="info-box">
    <strong>Tirupati Air Funnel Zones</strong><br>
...
def main():
    print("=== Tirupati Air Funnel Zones Tile Generator ===")
    print("Generating tiles for airport height restriction zones\n")
    
    settings = DEFAULT_VIEW_SETTINGS
    
    try:
        data_path = project_root / "data" / "arifunnel" / "Tirupati.geojson"
        output_dir = project_root / "tirupati_air_funnel_tiles"
        
        generator = TirupatiAirFunnelTileGenerator(
            data_path=data_path,
