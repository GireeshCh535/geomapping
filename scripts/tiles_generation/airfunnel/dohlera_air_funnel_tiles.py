#!/usr/bin/env python3
"""
Dohlera (Kozhikode) Air Funnel Zones Tile Generator
...
class DohleraAirFunnelTileGenerator:
    ...
    def get_color_map(self):
        ...
        return {
            ...
            '32 Meters Above Mean Sea Level': {'fill': '#559B33', 'outline': '#447c28'},
            '42 Meters Above Mean Sea Level': {'fill': '#8B36A4', 'outline': '#6f2b83'},
            '72 Meters Above Mean Sea Level': {'fill': '#CF9D2C', 'outline': '#a57d23'},
            '102 Meters Above Mean Sea Level': {'fill': '#3A6A99', 'outline': '#2e547a'},
            '152 Meters Above Mean Sea Level': {'fill': '#A0A0A0', 'outline': '#808080'},
        }
...
<head>
  ...
  <title>Dohlera Air Funnel Zones Viewer</title>
...
<body>
  <div id="map"></div>
  <div class="info-box">
    <strong>Dohlera Air Funnel Zones</strong><br>
...
def main():
    print("=== Dohlera Air Funnel Zones Tile Generator ===")
    print("Generating tiles for airport height restriction zones\n")
    
    settings = DEFAULT_VIEW_SETTINGS
    
    try:
        data_path = project_root / "data" / "arifunnel" / "Dohlera.geojson"
        output_dir = project_root / "dohlera_air_funnel_tiles"
        
        generator = DohleraAirFunnelTileGenerator(
            data_path=data_path,
