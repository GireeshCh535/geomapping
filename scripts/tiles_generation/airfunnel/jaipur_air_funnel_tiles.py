#!/usr/bin/env python3
"""
Jaipur (Kozhikode) Air Funnel Zones Tile Generator
...
class JaipurAirFunnelTileGenerator:
    ...
    def get_color_map(self):
        ...
        return {
            ...
            '396 Meters Above Mean Sea Level': {'fill': '#559B33', 'outline': '#447c28'},
            '401 Meters Above Mean Sea Level': {'fill': '#8B36A4', 'outline': '#6f2b83'},
            '406 Meters Above Mean Sea Level': {'fill': '#C157D9', 'outline': '#9a45ad'},
            '416 Meters Above Mean Sea Level': {'fill': '#CF9D2C', 'outline': '#a57d23'},
            '466 Meters Above Mean Sea Level': {'fill': '#3A6A99', 'outline': '#2e547a'},
            '496 Meters Above Mean Sea Level': {'fill': '#BFC040', 'outline': '#989933'},
            '526 Meters Above Mean Sea Level': {'fill': '#A0A0A0', 'outline': '#808080'},
        }
...
<head>
  ...
  <title>Jaipur Air Funnel Zones Viewer</title>
...
<body>
  <div id="map"></div>
  <div class="info-box">
    <strong>Jaipur Air Funnel Zones</strong><br>
...
def main():
    print("=== Jaipur Air Funnel Zones Tile Generator ===")
    print("Generating tiles for airport height restriction zones\n")
    
    settings = DEFAULT_VIEW_SETTINGS
    
    try:
        data_path = project_root / "data" / "arifunnel" / "Jaipur.geojson"
        output_dir = project_root / "jaipur_air_funnel_tiles"
        
        generator = JaipurAirFunnelTileGenerator(
            data_path=data_path,
