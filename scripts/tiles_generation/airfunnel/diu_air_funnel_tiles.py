#!/usr/bin/env python3
"""
Diu (Kozhikode) Air Funnel Zones Tile Generator
...
class DiuAirFunnelTileGenerator:
    ...
    def get_color_map(self):
        ...
        return {
            ...
            '39 Meters Above Mean Sea Level': {'fill': '#559B33', 'outline': '#447c28'},
            '49 Meters Above Mean Sea Level': {'fill': '#8B36A4', 'outline': '#6f2b83'},
            '59 Meters Above Mean Sea Level': {'fill': '#CF9D2C', 'outline': '#a57d23'},
            '89 Meters Above Mean Sea Level': {'fill': '#3A6A99', 'outline': '#2e547a'},
            '119 Meters Above Mean Sea Level': {'fill': '#BFC040', 'outline': '#989933'},
            '149 Meters Above Mean Sea Level': {'fill': '#A0A0A0', 'outline': '#808080'},
        }
...
def main():
    ...
    try:
        data_path = project_root / "data" / "arifunnel" / "Diu.geojson"
