#!/usr/bin/env python3
"""
Patna (Kozhikode) Air Funnel Zones Tile Generator
...
class PatnaAirFunnelTileGenerator:
    ...
    def get_color_map(self):
        ...
        return {
            ...
            '53 Meters Above Mean Sea Level': {'fill': '#559B33', 'outline': '#447c28'},
            '73 Meters Above Mean Sea Level': {'fill': '#8B36A4', 'outline': '#6f2b83'},
            '83 Meters Above Mean Sea Level': {'fill': '#CF9D2C', 'outline': '#a57d23'},
            '193 Meters Above Mean Sea Level': {'fill': '#A0A0A0', 'outline': '#808080'},
        }
...
<head>
  ...
  <title>Patna Air Funnel Zones Viewer</title>
...
<body>
  <div id="map"></div>
  <div class="info-box">
    <strong>Patna Air Funnel Zones</strong><br>
...
def main():
    print("=== Patna Air Funnel Zones Tile Generator ===")
    print("Generating tiles for airport height restriction zones\n")
    
    settings = DEFAULT_VIEW_SETTINGS
    
    try:
        data_path = project_root / "data" / "arifunnel" / "Patna.geojson"
        output_dir = project_root / "patna_air_funnel_tiles"
        
        generator = PatnaAirFunnelTileGenerator(
            data_path=data_path,
