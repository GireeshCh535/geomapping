#!/usr/bin/env python3
"""
Raigarh (Kozhikode) Air Funnel Zones Tile Generator
...
class RaigarhAirFunnelTileGenerator:
    ...
    def get_color_map(self):
        ...
        return {
            ...
            '265 Meters Above Mean Sea Level': {'fill': '#559B33', 'outline': '#447c28'},
            '385 Meters Above Mean Sea Level': {'fill': '#A0A0A0', 'outline': '#808080'},
        }
...
<head>
  ...
  <title>Raigarh Air Funnel Zones Viewer</title>
...
<body>
  <div id="map"></div>
  <div class="info-box">
    <strong>Raigarh Air Funnel Zones</strong><br>
  ...
  <div class="legend">
    ...
    <div class="legend-item">
      ...
      <span style="font-size: 10px;">385m</span>
    </div>
  </div>
...
def main():
    print("=== Raigarh Air Funnel Zones Tile Generator ===")
    print("Generating tiles for airport height restriction zones\n")
    
    settings = DEFAULT_VIEW_SETTINGS
    
    try:
        data_path = project_root / "data" / "arifunnel" / "Raigarh.geojson"
        output_dir = project_root / "raigarh_air_funnel_tiles"
        
        generator = RaigarhAirFunnelTileGenerator(
            data_path=data_path,
