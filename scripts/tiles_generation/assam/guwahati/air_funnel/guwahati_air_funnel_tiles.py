#!/usr/bin/env python3
"""
Guwahati Air Funnel Zones Tile Generator
...
class GuwahatiAirFunnelTileGenerator:
    ...
    def get_color_map(self):
        """Color mapping for height restriction zones (Guwahati)"""
        return {
            'For construction mandatory NOC from AAI is required': {'fill': '#91302D', 'outline': '#6B2421'},
            '64 Meters Above Mean Sea Level': {'fill': '#559B33', 'outline': '#3F7326'},
            '69 Meters Above Mean Sea Level': {'fill': '#7EBC4F', 'outline': '#5F8E3B'},
            '79 Meters Above Mean Sea Level': {'fill': '#8B36A4', 'outline': '#682881'},
            '159 Meters Above Mean Sea Level': {'fill': '#CF9D2C', 'outline': '#A37D23'},
            '189 Meters Above Mean Sea Level': {'fill': '#A0A0A0', 'outline': '#787878'},
        }
...
def main():
    ...
    try:
        # Paths
        data_path = project_root / "data" / "assam" / "guwahati" / "air_funnel_zones" / "Guwahati.geojson"
