#!/usr/bin/env python3
"""
Dedicated script to generate high-quality PNG tiles from Guwahati Masterplan RGBA GeoTIFF
...
class GuwahatiRGBATileGenerator:
    """
    Generate high-quality PNG tiles from Guwahati Masterplan RGBA GeoTIFF
    """
    
    def __init__(self, data_dir: str = "data/assam/guwahati",
                 output_dir: str = "guwahati_masterplan_tiles"):
        self.data_dir = Path(data_dir)
        self.output_dir = Path(output_dir)
        self.output_dir.mkdir(exist_ok=True)
        
        logger.info("Guwahati RGBA Tile Generator initialized")
    ...
    def generate_tiles(self, min_zoom=8, max_zoom=16):
        """Generate PNG tiles for Guwahati Masterplan"""
        ...
        logger.info(f"Generated {total_tiles} PNG tiles for Guwahati Masterplan")
    ...
    def create_supporting_files(self, bounds, min_zoom, max_zoom):
        ...
        style_json = {
            "version": 8,
            "name": "Assam - Guwahati Masterplan",
            "sources": {
                "guwahati-masterplan": {
                    "type": "raster",
                    "tiles": [
                        "https://d17yosovmfjm4.cloudfront.net/assam/guwahati_masterplan/{z}/{x}/{y}.png"
                    ],
                    "tileSize": 256
                }
            },
            "layers": [
                {
                    "id": "guwahati-masterplan-layer",
                    "type": "raster",
                    "source": "guwahati-masterplan",
                    "paint": {
                        "raster-opacity": 0.8
                    }
                }
        ...
        tilejson = {
            "tilejson": "2.2.0",
            "name": "Assam - Guwahati Masterplan",
            "description": "Master plan tiles for Guwahati, Assam",
            "version": "1.0.0",
            "attribution": "Guwahati Development Authority",
            "template": "",
            "legend": "",
            "scheme": "xyz",
            "tiles": [
...
<html>
<head>
    <title>Assam - Guwahati Masterplan</title>
...
def main():
    """Main function"""
    logger.info("Starting Guwahati RGBA Masterplan tile generation")
    
    # Initialize generator
    generator = GuwahatiRGBATileGenerator()
    
    # Generate tiles with higher zoom levels for better quality
    generator.generate_tiles(min_zoom=17, max_zoom=18)
    
    logger.info("Guwahati RGBA Masterplan tile generation completed!")
