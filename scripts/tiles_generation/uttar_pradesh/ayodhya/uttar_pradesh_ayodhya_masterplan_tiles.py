#!/usr/bin/env python3
"""
Dedicated script to generate high-quality PNG tiles from Ayodhya Masterplan RGBA GeoTIFF
...
class AyodhyaRGBATileGenerator:
    """
    Generate high-quality PNG tiles from Ayodhya Masterplan RGBA GeoTIFF
    """
    
    def __init__(self, data_dir: str = "data/uttar-pradesh/ayodhya",
                 output_dir: str = "ayodhya_masterplan_tiles"):
        self.data_dir = Path(data_dir)
        self.output_dir = Path(output_dir)
        self.output_dir.mkdir(exist_ok=True)
        
        logger.info("Ayodhya RGBA Tile Generator initialized")
    ...
    def generate_tiles(self, min_zoom=8, max_zoom=16):
        """Generate PNG tiles for Ayodhya Masterplan"""
        ...
        logger.info(f"Generated {total_tiles} PNG tiles for Ayodhya Masterplan")
    ...
    def create_supporting_files(self, bounds, min_zoom, max_zoom):
        ...
        style_json = {
            "version": 8,
            "name": "Uttar Pradesh - Ayodhya Masterplan",
            "sources": {
                "ayodhya-masterplan": {
                    "type": "raster",
                    "tiles": [
                        "https://d17yosovmfjm4.cloudfront.net/uttar-pradesh/ayodhya_masterplan/{z}/{x}/{y}.png"
                    ],
                    "tileSize": 256
                }
            },
            "layers": [
                {
                    "id": "ayodhya-masterplan-layer",
                    "type": "raster",
                    "source": "ayodhya-masterplan",
                    "paint": {
                        "raster-opacity": 0.8
                    }
                }
        ...
        tilejson = {
            "tilejson": "2.2.0",
            "name": "Uttar Pradesh - Ayodhya Masterplan",
            "description": "Master plan tiles for Ayodhya, Uttar Pradesh",
            "version": "1.0.0",
            "attribution": "Ayodhya Development Authority",
            "template": "",
            "legend": "",
            "scheme": "xyz",
            "tiles": [
...
<html>
<head>
    <title>Uttar Pradesh - Ayodhya Masterplan</title>
...
def main():
    """Main function"""
    logger.info("Starting Ayodhya RGBA Masterplan tile generation")
    
    # Initialize generator
    generator = AyodhyaRGBATileGenerator()
    
    # Generate tiles with higher zoom levels for better quality
    generator.generate_tiles(min_zoom=17, max_zoom=18)
    
    logger.info("Ayodhya RGBA Masterplan tile generation completed!")
