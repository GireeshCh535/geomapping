#!/usr/bin/env python3
"""
Ayodhya Air Funnel Zones Tile Generator
Generates PNG tiles for Airport Height Restriction Zones
Based on Hyderabad, Bengaluru, Kozhikode, and Ahmedabad air funnel rendering approach
"""
...
class AyodhyaAirFunnelTileGenerator:
    ...
    def get_color_map(self):
        """Color mapping for height restriction zones (Ayodhya)"""
        return {
            'For construction mandatory NOC from AAI is required': {'fill': '#91302D', 'outline': '#6B2421'},
            '110 Meters Above Mean Sea Level': {'fill': '#559B33', 'outline': '#3F7326'},
            '120 Meters Above Mean Sea Level': {'fill': '#7EBC4F', 'outline': '#5F8E3B'},
            '130 Meters Above Mean Sea Level': {'fill': '#8B36A4', 'outline': '#682881'},
            '240 Meters Above Mean Sea Level': {'fill': '#A0A0A0', 'outline': '#787878'},
        }
