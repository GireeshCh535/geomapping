#!/usr/bin/env python3
"""
Fast S3 upload script for Hyderabad Future City tiles
Uploads both geotiff and boundary tile sets to S3 with proper mapping and deletion of existing files
"""
...
class FastHyderabadFutureCityTilesUploader:
    """
    Fast uploader for Hyderabad Future City tiles to S3
    """
    ...
    def __init__(self, delete_existing=True):
        ...
        self.folder_mappings = {
            'hyderabad_future_city_geotiff_tiles': 'telangana/hyderabad/hyderabad_future_city/geotiff',
            'hyderabad_future_city_boundary_tiles': 'telangana/hyderabad/hyderabad_future_city'
        }

        logger.info("Hyderabad Future City Tiles Uploader initialized")
    ...
    def upload_all_tiles(self):
        """Upload all Hyderabad Future City tile sets to S3"""
        logger.info("Starting upload of all Hyderabad Future City tiles")
...
def main():
    """Main function"""
    logger.info("Starting Hyderabad Future City tiles upload to S3")
    ...
    try:
        ...
        uploader = FastHyderabadFutureCityTilesUploader(delete_existing=delete_existing)
        total_uploaded = uploader.upload_all_tiles()

        logger.info(f"🎉 Hyderabad Future City tiles upload completed! Total files: {total_uploaded}")
